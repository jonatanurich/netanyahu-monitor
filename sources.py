...
# --- סיקור זר: Google News RSS, יציב יותר מפידים ישירים שנוטים להישבר ---
_GN = "https://news.google.com/rss/search?q={q}&hl=en-US&gl=US&ceid=US:en"
RSS_FEEDS.update({
    "🌍 חו״ל — Netanyahu": _GN.format(q="Netanyahu"),
    "🌍 חו״ל — Israel politics": _GN.format(q="Israel+election+OR+coalition+OR+poll"),
    "🌍 חו״ל — Israeli PM": _GN.format(q="%22Israeli+prime+minister%22"),
})
